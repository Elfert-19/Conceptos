...
public class EnemySensors : MonoBehaviour {
    ...
    // Carga un List con los objetos que puede interactuar el enemigo para luego ser consumidos por el script de desicion
    ...
    // Descarga el List al salir del area de deteccion;
    ...
    // Funcion que carga y descarga un List con todo lo que se encuentre en el campo de vision de la IA para ser consumido por el script de desicion
    public void Vision()
    {
    ...
    // Funcion que carga y descarga un List con todo lo que oye la IA para ser consumido por el script de desicion
